...
//console.log('headerHash ' + JSON.stringify(headerHash));
...
//console.log('headerBigNum ' + JSON.stringify(headerBigNum));
        if (job.target.ge(headerBigNum)){
            blockHex = job.serializeBlock(headerBuffer, coinbaseBuffer).toString('hex');
//console.log('blockHex ' + JSON.stringify(blockHex));
...
//console.log('previousDifficulty ' + previousDifficulty);
