...
exports.bufferToBigInt = function bufferToBigInt(buffer, endian = 'little') {
...
exports.uint256BufferFromHash = function(hex){
    ...
    var fromHex = (typeof hex === 'number') ?
       Buffer.from(hex.toString(16).padStart(hex.toString(16).length % 2 ? hex.toString(16).length + 1 : hex.toString(16).length, '0'), 'hex') :
          (typeof hex === 'string') ?
              Buffer.from(hex, 'hex') : Buffer.from(hex);
...
exports.bufferToCompactBits = function(startingBuff){
    ...
    var bigNum = BigInt('0x' + startingBuff.toString('hex'));
    var buff = Buffer.from(bigNum.toString(16), 'hex');
...
exports.bigIntFromBitsBuffer = function(bitsBuff) {
    ...
    var exponent = 8n * BigInt(numBytes - 3);  // Používáme BigInt pro exponent
    var powerOfTwo = 2n ** exponent;
    var target = bigBits * powerOfTwo;
    return target;
};
...
exports.convertBitsToBuff = function(bitsBuff){
    var target = exports.bigIntFromBitsBuffer(bitsBuff);
